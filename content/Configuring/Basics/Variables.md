...
| directional_focus_in_fullscreen | If set to "window", it allows hl.dsp.focus({ direction }) to seek windows when focus is on a fullscreen window. If set to "monitor", it will seek just monitors instead. 0 - monitor, 1 - window | int | `1` |
