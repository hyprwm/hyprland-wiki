...
The transfer function assumed to be in use on a display for SDR content is defined by `sdr_eotf = X`:

```plain
default - default value, currently Gamma 2.2
auto    - use global setting render:cm_sdr_eotf
gamma22 - Gamma 2.2
srgb    - sRGB
```
