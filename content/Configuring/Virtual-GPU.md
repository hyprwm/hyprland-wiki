...
```
hyprctl --instance 0 dispatch exec Sunshine
```
...
If everything is configured and working correctly, you can set your server in your `hyprland.conf` file to be autostarted. (See the [FAQ](../../FAQ/#how-do-i-autostart-my-favorite-apps)):
```
exec-once = Sunshine
```
