...
### How do I screenshot?
<!-- TODO link to useful utils instead of telling the same story twice -->
...
[XDG specification](https://wiki.archlinux.org/title/Cursor_themes#Configuration).
...
See [Environment Variables](../configuring/core/environment-variables)
