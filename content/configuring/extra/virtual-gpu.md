...
If everything is configured and working correctly, you can set your server in your `hyprland.lua` file to be autostarted. (See the [Autostart](../../core/autostart)):
```lua
