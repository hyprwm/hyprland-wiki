...
| group_on_movetoworkspace | whether using movetoworkspace[silent] will merge the window into the first window of the workspace if it is a unlocked group | bool | false |
