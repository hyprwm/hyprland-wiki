...
Systemd users can also start Hyprland, using [uwsm](https://github.com/Vladimir-csp/uwsm). This is the recommended way to launch Hyprland on systemd-based distros. See [uwsm](../../Systemd-start) page for further instrustions.
