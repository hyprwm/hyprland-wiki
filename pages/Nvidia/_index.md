...
_Note: if you have problems with Nvidia's drivers, try with the [Nouveau driver](https://wiki.archlinux.org/title/Nouveau). This driver might be more stable, however, the performance and feature set might be worse._
