...
startup, edit `hyprland.conf` and add: `exec-once = hypridle`. If Hyprland is started with a systemd service, you can use `systemctl --user enable --now hypridle.service`.
